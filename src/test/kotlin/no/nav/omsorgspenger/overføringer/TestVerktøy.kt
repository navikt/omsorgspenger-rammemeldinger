...
internal fun TestRapid.opphørOverføringer(
    ...
    printSisteMelding()
    ventPå(1)
    val løst = sisteMeldingSomJSONObject().getJSONObject("@løsninger").getJSONObject("OpphøreOverføringer").getString("løst").let {
