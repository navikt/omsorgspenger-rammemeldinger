...
internal class PeriodisertOmsorsgdagerTilgjengeligTilOverføringerTest {
    ...
    fun `Alle periodene har samme antall dager tilgjengelig for overføring`() {
        val forventedeOverføringer = listOf(Overføring(periode = Periode("2020-05-01/2040-01-01"), antallDager = 10, knekkpunkt = setOf()))
    ...
    fun `Første periode har annet antall dager enn resterende perioder`() {
        val forventedeOverføringer = listOf(
            Overføring(periode = Periode("2020-05-01/2020-12-31"), antallDager = 5, knekkpunkt = setOf()),
            Overføring(periode = Periode("2021-01-01/2040-01-01"), antallDager = 10, knekkpunkt = setOf())
        )
    ...
    fun `Perioder med hull i`() {
        val forventedeOverføringer = listOf(
            Overføring(periode = Periode("2020-05-01/2021-01-02"), antallDager = 10, knekkpunkt = setOf()),
            Overføring(periode = Periode("2021-01-10/2021-06-10"), antallDager = 5, knekkpunkt = setOf()),
            Overføring(periode = Periode("2021-07-01/2026-01-01"), antallDager = 10, knekkpunkt = setOf())
        )
